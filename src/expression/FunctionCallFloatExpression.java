...
public class FunctionCallFloatExpression extends Expression implements FunctionCallFloat{
	public FloatingPointLiteral returnValue;
	public Identifier id;
	public ActualParameter parameters;
	
	public FunctionCallFloatExpression (Identifier i, ActualParameter p)
	{
		this.id = i;
		this.parameters = p;
	}
	@Override
	public FloatingPointLiteral evaluate(Context c)
	{
		...
		Context.callStackFloat.push(this);
		fc.st.execute(functionContext);
		fc.r.execute(functionContext);
		Context.callStackFloat.pop();
		return returnValue;
	...
	@Override
	public void setReturnValue(FloatingPointLiteral a) {
